...
class TestMinWaitingtime(unittest.TestCase):
    ...
    def test2(self):
        t_r = 30 #service time is 5 minutes
        n_r = 40 #40 people waiting for the same service,
        k_i = [2,2,1] # 3 service center offer 2 and 1 kind of service respectively
    ...
    def testCatchError(self):
        ...
        n_r = 40 #40 people waiting for the same service,
        k_i = [2,2,1] # 3 service center offer 2 and 1 kind of service respectively
        s_i_r = [0,0,0] # all service offer this kind of service
